...
class New_Document(object):
    ...
    def add_heading(self, text="", type=0, bold=False, italic=False, underline=False, font=False):
        """
        ...
        :rtype: New_Header
        """
        return New_Header(self.document, text, type, bold, italic, underline, font)

    def add_paragraph(self, text="", bold=False, italic=False, underline=False, font=False):
        """
        ...
        :rtype: New_Paragraph
        """
        return New_Paragraph(self.document, text, bold, italic, underline, font)
...
class New_Header(object):
    ...
    def __init__(self, doc, text="", type=0, bold=False, italic=False, underline=False, font=False):
        self.header = doc.add_heading("", type)
        if text != "":
            self.write(text=str(text), bold=bold, italic=italic, underline=underline, font=font)
    ...
    def write(self, text="", bold=False, italic=False, underline=False, font=False):
        """
    ...
    def write_to_new_line(self, text="", bold=False, italic=False, underline=False):
        """
...
class New_Paragraph(object):
    ...
    def __init__(self, doc, text="", bold=False, italic=False, underline=False, font=False):
    ...
    def write_to_new_line(self, text="", bold=False, italic=False, underline=False):
        """
        Writes to new line in paragraph
...
class Smart_Heading(object):
    ...
    def __init__(self, text="", type=0, bold=False, italic=False, underline=False, condition=lambda x: True, font=False):
        self.text = text
        self.bold = bold
        self.italic = italic
...
class Smart_Headings_Displayer(object):
    ...
    def get_empty_smart_heading(self):
        heading = Smart_Heading(text="", type=0, bold=False, italic=False, underline=False, condition=lambda x: True)
    ...
    def update_heading(self, data):
        ...
        if heading.needs_displayed:
            if heading.condition(data):
                self.doc.add_heading(text=heading.text, type=heading.type, bold=heading.bold,
